const levenshtein = (string1, string2, costs) => {
    let i; let j; const l1 = string1.length; const l2 = string2.length; let flip; let ch; let chl; let ii; let ii2; let cost;
    ...
    for (i = 0; i < l1; ++i, flip = cutHalf - flip) {
        ...
        for (j = 0; j < l2; ++j, ++ii, ++ii2) {
            cost = (ch === string2[j] ? 0 : (chl === string2[j].toLowerCase()) ? cri : cr);
...
export const compareProposition = (proposition1, proposition2) => {
    const procent = 90;
